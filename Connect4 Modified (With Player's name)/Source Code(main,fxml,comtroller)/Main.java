...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Anannya Banerjee");
		alert.setContentText("I am Anannya, a student of Computer Science Engineering," +
				" really love to learn" +
				" and implements with my own hand" +
				". I really enjoyed to make the game." );
